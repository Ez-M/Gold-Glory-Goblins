...
function Navbar() {
    ...
    const {attackPlayer,enemy, fighting}= useContext(CombatStuff) //combatStuff is info relevant to running combat instances. Used here for conditionally rendering the navbar.
